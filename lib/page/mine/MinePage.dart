import 'dart:io';
import 'dart:ui';
import 'package:first_flutter/page/mine/watch_history_page.dart';
...
class _MinePageState extends State<MinePage>
  ...
  void _getAvatarPath() {
    var userAvatarPath =
        CacheManager.getInstance()!.get<String>("user_avatar_path") as String;
    if (userAvatarPath != null && userAvatarPath.isNotEmpty) {
      setState(() {
        _imageFile = File(userAvatarPath.toString());
      });
    }
  }
